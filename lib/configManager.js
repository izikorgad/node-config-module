...
exports.updateConfig = exports.setConfigChangeCallback = exports.getConfig = exports.init = exports.getLocalConfig = undefined;
...
const getLocalConfig = exports.getLocalConfig = (configFile = configFileName, defaultConfig) => {
...
const getConfig = exports.getConfig = (configFile = configFileName) => {
